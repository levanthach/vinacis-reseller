              ...
              <tr class="kt-datatable__row" style="left: 0px;">
                <th data-field="RecordID" class="kt-datatable__cell--center kt-datatable__cell kt-datatable__cell--check">
                  <span style="width: 20px;"><label class="kt-checkbox kt-checkbox--single kt-checkbox--all kt-checkbox--solid">
                    ...
                    <th data-field="Country" class="kt-datatable__cell kt-datatable__cell--sort"><span style="width: 133px;">Mã CODE</span></th>
                    <th data-field="ShipAddress" class="kt-datatable__cell kt-datatable__cell--sort"><span style="width: 112px;">Loại Voucher</span></th>
                    <th data-field="ShipAddress" class="kt-datatable__cell kt-datatable__cell--sort"><span style="width: 133px;">Mô tả</span></th>
                      <th data-field="ShipDate" class="kt-datatable__cell kt-datatable__cell--sort"><span style="width: 133px;">Ngày sử dụng</span></th>
                      <th data-field="ShipDate" class="kt-datatable__cell kt-datatable__cell--sort"><span style="width: 133px;">Hạn sử dụng</span></th>
                      <th data-field="ShipDate" class="kt-datatable__cell kt-datatable__cell--sort"><span style="width: 133px;">Người sử dụng</span></th>
                      <th data-field="Status" class="kt-datatable__cell kt-datatable__cell--sort"><span style="width: 80px;">Trạng thái</span></th>
                      ...
                      <tbody class="kt-datatable__body" style=""><tr data-row="0" class="kt-datatable__row" style="left: 0px;">
                        <td class="kt-datatable__cell--center kt-datatable__cell kt-datatable__cell--check" data-field="RecordID">
                          ...
                          <td data-field="Country" class="kt-datatable__cell"><span style="width: 133px;">Xy9D-fDlj-JK87</span></td>
                          <td data-field="Country" class="kt-datatable__cell"><span style="width: 112px;">All Services</span></td>
                          <td data-field="ShipAddress" class="kt-datatable__cell"><span style="width: 133px;">Giảm 500K</span></td>
                          ...
                          <td data-field="ShipDate" class="kt-datatable__cell"><span style="width: 133px;">Lê Văn T</span></td>
                          <td data-field="Status" class="kt-datatable__cell"><span style="width: 80px;"><span class="kt-badge  kt-badge--primary kt-badge--inline kt-badge--pill">Canceled</span></span></td>
